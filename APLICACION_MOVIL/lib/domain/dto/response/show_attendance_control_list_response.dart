...
class ShowAttendanceControlListResponse {
  ...
  ShowAttendanceControlListResponse(this._studentsPresentList, this._studentsMissingList, this._numberOfDoubtfulStudents, this._pictureWithFacesDetectedAndNamesBase64);
